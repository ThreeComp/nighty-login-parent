...
public class LoginSuccessResult implements Serializable {
    ...
    private List<L_Resource> resources; //用户权限

    public LoginSuccessResult() {}

    public LoginSuccessResult(String token, String nickname, String username, String roleType, List<L_Resource> resources) {
        this.token = token;
